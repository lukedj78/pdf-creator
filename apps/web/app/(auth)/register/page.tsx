...
import { signUp, signIn, authClient } from "@workspace/auth/client"
          ...
          <form onSubmit={handleSubmit}>
            <FieldGroup className="gap-6">
              ...
              <Field className="gap-4">
                <Button type="submit" size="lg" disabled={loading} className="rounded-lg cursor-pointer h-10 hover:bg-primary/80">
